...
if __name__ == "__main__":
    ...
    local = eval.at['local', 'traffic']
    wireless = eval.at['wireless', 'traffic']
    
    print(f'local traffic: {local}')
    print(f'wireless traffic: {wireless}')
    print(f'-> {local/(local + wireless)}% handled locally')
